...
#endif
static const char *ng0 = "v:/hipsBuilds/P_hips_v23.0/rst/hips/mcb/memc_calibration_datacheck_dq.v";
...
LAB294:    t12 = (t240 + 4);
    t14 = *((unsigned int *)t240);
    t15 = *((unsigned int *)t12);
    t16 = (t14 || t15);
    if (t16 > 0)
        goto LAB295;

LAB296:    memcpy(t25, t240, 8);

LAB297:    memset(t32, 0, 8);
    t74 = (t25 + 4);
...
LAB314:    memcpy(t88, t32, 8);

LAB315:    memset(t96, 0, 8);
    t128 = (t88 + 4);
...
LAB271:    memset(t13, 0, 8);
    t31 = (t240 + 4);
    t14 = *((unsigned int *)t31);
    t15 = (~(t14));
    t16 = *((unsigned int *)t240);
    t17 = (t16 & t15);
    t18 = (t17 & 1U);
    if (t18 != 0)
        goto LAB272;
...
LAB290:    xsi_set_current_line(574, ng0);
    ...
    t5 = ((char*)((ng2)));
    memset(t240, 0, 8);
    xsi_vlog_unsigned_add(t240, 8, t4, 8, t5, 8);
    t11 = (t0 + 10248);
    xsi_vlogvar_wait_assign_value(t11, t240, 0, 0, 8, 0LL);
...
LAB283:    t45 = *((unsigned int *)t25);
    t48 = *((unsigned int *)t74);
    *((unsigned int *)t25) = (t45 | t48);
    t80 = (t13 + 4);
    t81 = (t19 + 4);
    t49 = *((unsigned int *)t80);
    t50 = (~(t49));
...
LAB306:    t44 = *((unsigned int *)t25);
    t45 = *((unsigned int *)t70);
    *((unsigned int *)t25) = (t44 | t45);
    t71 = (t240 + 4);
    t72 = (t19 + 4);
    t48 = *((unsigned int *)t240);
    t49 = (~(t48));
    t50 = *((unsigned int *)t71);
    t51 = (~(t50));
    t52 = *((unsigned int *)t19);
...
LAB330:    *((unsigned int *)t145) = 1;
    goto LAB333;

LAB334:    *((unsigned int *)t152) = 1;
    goto LAB337;
...
LAB338:    t170 = *((unsigned int *)t180);
    t172 = *((unsigned int *)t156);
    *((unsigned int *)t180) = (t170 | t172);
    t157 = (t96 + 4);
    t158 = (t152 + 4);
    t173 = *((unsigned int *)t96);
    t174 = (~(t173));
    ...
    *((unsigned int *)t180) = (t190 & t184);
    t191 = *((unsigned int *)t180);
    *((unsigned int *)t180) = (t191 & t185);
    goto LAB340;
...
extern void secureip_m_00000000002905671792_3836920182_init()
{
	...
	xsi_register_didat("secureip_m_00000000002905671792_3836920182", "isim/main_isim_beh.exe.sim/secureip/m_00000000002905671792_3836920182.didat");
