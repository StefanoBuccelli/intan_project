...
//	wire 				DAC_en_5, DAC_en_6, DAC_en_7, DAC_en_8;
   ...
   //									  stim_on_A1[1], stim_pol_A1[1], amp_settle_A1[1], charge_recov_A1[1], ADC_triggers[3:0], manual_triggers[3:0] }; 
	...
	// MM - UPDATE - WINDOW DISCRIMINATOR - 1/16/18
	// (ADDED to module: scalable_filter)
	...
	scalable_filter #(
		...
		.channel			(channel),
		.filter_input 		(DAC_register_1),
		.sequencer_in (DAC_sequencer_1),
		...
		.DIN 		(DAC_DIN_1),
		.thrsh     (DAC_thresh_1),
		.thrsh_pol (DAC_thresh_pol_1),
		.thrsh_out (DAC_thresh_out[0]),
		.fsm_start_win_in (DAC_start_win_1),
	...
	scalable_filter #(
		...
		.main_state		(main_state),
		.channel			(channel),
		.filter_input 		(DAC_register_2),
		.sequencer_in (DAC_sequencer_2),
		...
		.DIN 		(DAC_DIN_2),
		.thrsh     (DAC_thresh_2),
		.thrsh_pol (DAC_thresh_pol_2),
		.thrsh_out (DAC_thresh_out[1]),
		.fsm_start_win_in (DAC_start_win_2),
		...
		.main_state		(main_state),
		.channel			(channel),
		.filter_input 		(DAC_register_3),
		.sequencer_in (DAC_sequencer_3),
		...
		.DIN 		(DAC_DIN_3),
		.thrsh     (DAC_thresh_3),
		.thrsh_pol (DAC_thresh_pol_3),
		.thrsh_out (DAC_thresh_out[2]),
		.fsm_start_win_in (DAC_start_win_3),
		...
		.main_state		(main_state),
		.channel			(channel),
		.filter_input 		(DAC_register_4),
		.sequencer_in (DAC_sequencer_4),
		...
		.DIN 		(DAC_DIN_4),
		.thrsh     (DAC_thresh_4),
		.thrsh_pol (DAC_thresh_pol_4),
		.thrsh_out (DAC_thresh_out[3]),
		.fsm_start_win_in (DAC_start_win_4),
		...
		.main_state		(main_state),
		.channel			(channel),
		.filter_input 		(DAC_register_5),
		.sequencer_in (DAC_sequencer_5),
		...
		.DIN 		(DAC_DIN_5),
		.thrsh     (DAC_thresh_5),
		.thrsh_pol (DAC_thresh_pol_5),
		.thrsh_out (DAC_thresh_out[4]),
		.fsm_start_win_in (DAC_start_win_5),
		...
		.main_state		(main_state),
		.channel			(channel),
		.filter_input 		(DAC_register_6),
		.sequencer_in (DAC_sequencer_6),
		...
		.DIN 		(DAC_DIN_6),
		.thrsh     (DAC_thresh_6),
		.thrsh_pol (DAC_thresh_pol_6),
		.thrsh_out (DAC_thresh_out[5]),
		.fsm_start_win_in (DAC_start_win_6),
		...
		.main_state		(main_state),
		.channel			(channel),
		.filter_input 		(DAC_register_7),
		.sequencer_in (DAC_sequencer_7),
		...
		.DIN 		(DAC_DIN_7),
		.thrsh     (DAC_thresh_7),
		.thrsh_pol (DAC_thresh_pol_7),
		.thrsh_out (DAC_thresh_out[6]),
		.fsm_start_win_in (DAC_start_win_7),
		...
		.main_state		(main_state),
		.channel			(channel),
		.filter_input 		(DAC_register_8),
		.sequencer_in (DAC_sequencer_8),
		...
		.DIN 		(DAC_DIN_8),
		.thrsh     (DAC_thresh_8),
		.thrsh_pol (DAC_thresh_pol_8),
		.thrsh_out (DAC_thresh_out[7]),
		.fsm_start_win_in (DAC_start_win_8),
	...
	// MM 5/27/2018 - IIT: FILTERS FOR EVENTS STREAM TAB - START UPDATE
	okTriggerIn		ti49 (.ok1(ok1),						 .ep_addr(8'h49), .ep_clk(ti_clk), .ep_trigger(ep49trigin));
	okTriggerIn		ti4a (.ok1(ok1),						 .ep_addr(8'h4a), .ep_clk(ti_clk), .ep_trigger(ep49trigin));
	// MM - END UPDATE
