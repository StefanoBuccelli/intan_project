...
// RHS2000 chip filters help dialog.

HelpDialogChipFilters::HelpDialogChipFilters(QWidget *parent) :
    QDialog(parent)
{
    setWindowTitle(tr("RHS2116 On-Chip Filters"));
    ...
    QLabel *label1 = new QLabel(tr("Each amplifier on an RHS2116 chip has a pass band defined by analog circuitry "
    ...
    QLabel *label2 = new QLabel(tr("Each RHS2116 includes an on-chip module that performs digital signal processing "
    ...
    QLabel *label3 = new QLabel(tr("The diagram below shows a simplified functional diagram of one channel in an "
                                   "RHS2116 chip.  For more information, consult the <b>RHS2116 digital "
                                   "electrophysiology stimulator/amplifier chip datasheet</b>, "
                                   "which can be found on the <a href=\"http://www.intantech.com/downloads.html\">Downloads</a> "
                                   "page of the Intan Technologies website."));
    ...
    QLabel *label5 = new QLabel(tr("For a detailed mathematical description of all three on-chip filters, visit the "
                                   ...
                                   "RHD2000 amplifier filter characteristics</b>.  (RHS and RHD filters are identical.)"
                                   ));
