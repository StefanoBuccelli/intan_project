    ...
    QDialog(parent)
{
    ...
    QLabel *label1 = new QLabel(tr("All RHS2000 chips have a hardware 'fast settle' function that rapidly "
    ...
    QLabel *label3 = new QLabel(tr("Real-time control of the fast settle function is enabled by checking the <b>Realtime "
                                   "Settle Control</b> box and selecting a Digital In port on the Intan Stimulation / Recording Controller that will "
                                   "be used to activate blanking.  If this box is checked, a logic high signal on the selected "
                                   "Digital In port will enable amplifier fast settling with a latency of 4-5 amplifier sampling "
