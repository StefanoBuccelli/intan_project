...
public:
    ...
    // SB update
    int loadReplayData(int numBlocks, double sampleRate, bool saveToDisk,
                          QDataStream &out, SaveFormat format, bool saveTtlOut, bool saveDcAmps, ReferenceSource &referenceSource, ifstream &fileName);

//    int loadReplayData(int numBlocks, double sampleRate, bool saveToDisk,
//                          QDataStream &out, SaveFormat format, bool saveTtlOut, bool saveDcAmps, ReferenceSource &referenceSource, vector<double> &vector_data, int count_new_data_ready);
    // end update
...
private:
    ...
    QVector<QVector<double> > filterState;
