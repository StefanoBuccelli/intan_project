    ...
    QDialog(parent)
{
    ...
    QLabel *label1 = new QLabel(tr("Digital or analog inputs lines may be used to trigger "
                                   ...
                                   "threshold between logic high and logic low is 1.65V."));
    ...
    digitalInputComboBox->addItem(tr("ANALOG IN 1"));
    digitalInputComboBox->addItem(tr("ANALOG IN 2"));
    digitalInputComboBox->addItem(tr("ANALOG IN 3"));
    digitalInputComboBox->addItem(tr("ANALOG IN 4"));
    digitalInputComboBox->addItem(tr("ANALOG IN 5"));
    digitalInputComboBox->addItem(tr("ANALOG IN 6"));
    digitalInputComboBox->addItem(tr("ANALOG IN 7"));
    digitalInputComboBox->addItem(tr("ANALOG IN 8"));
