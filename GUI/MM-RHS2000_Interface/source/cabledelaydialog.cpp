    ...
    QDialog(parent)
{
    QLabel *label1 = new QLabel(
                tr("The RHS2000 Stimulation / Recording Controller can compensate for the nanosecond-scale time delays "
                   "resulting from finite signal velocities on the Stim SPI interface cables.  "
    ...
    QLabel *label3 = new QLabel(
                tr("Note that the optimum delay setting for a particular Stim SPI cable length will change if the "
    ...
    setWindowTitle(tr("Manual Stim SPI Cable Delay Configuration"));
}
