...
struct qt_meta_stringdata_BandwidthDialog_t {
    QByteArrayData data[5];
    char stringdata0[67];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_BandwidthDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_BandwidthDialog_t qt_meta_stringdata_BandwidthDialog = {
    {
QT_MOC_LITERAL(0, 0, 15), // "BandwidthDialog"
QT_MOC_LITERAL(1, 16, 21), // "onLineEditTextChanged"
QT_MOC_LITERAL(2, 38, 0), // ""
QT_MOC_LITERAL(3, 39, 20), // "onDspCheckBoxChanged"
QT_MOC_LITERAL(4, 60, 6) // "enable"

    },
    "BandwidthDialog\0onLineEditTextChanged\0"
    "\0onDspCheckBoxChanged\0enable"
};
...
const QMetaObject BandwidthDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_BandwidthDialog.data,
      qt_meta_data_BandwidthDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *BandwidthDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_BandwidthDialog.stringdata0))
