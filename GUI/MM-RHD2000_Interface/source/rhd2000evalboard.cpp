...
void Rhd2000EvalBoard::initialize()
{
    ...
    setDacWindowStart(0,0);
    setDacWindowStart(1,0);
    setDacWindowStart(2,6);
    setDacWindowStart(3,6);
    setDacWindowStart(4,0);
    setDacWindowStart(5,0);
    setDacWindowStart(6,0);
    setDacWindowStart(7,0);

    setDacWindowStop(0,3);
    setDacWindowStop(1,3);
    setDacWindowStop(2,9);
    setDacWindowStop(3,9);
    setDacWindowStop(4,0);
    setDacWindowStop(5,0);
    setDacWindowStop(6,0);
    setDacWindowStop(7,0);
    // END UPDATE
...
// Get threshold levels for spike detection
void Rhd2000EvalBoard::setDacThreshold(int dacChannel, int threshold, bool trigPolarity)
{
    ...
    if (threshold < 0 || threshold > 65535) {
        cerr << "Error in Rhd2000EvalBoard::setDacThreshold: threshold value out of range." << endl;
        return;
    }
...
void Rhd2000EvalBoard::setDacWindowStart(int dacChannel, int sample)
{
    if (dacChannel < 0 || dacChannel > 7) {
        cerr << "Error in Rhd2000EvalBoard::setDacWindowStart: dacChannel out of range." << endl;
        return;
    }

    if (sample < 0 || sample > 65535) {
        cerr << "Error in Rhd2000EvalBoard::setDacWindowStart: sample value out of range." << endl;
        return;
    }
...
// Set sample index for start of a threshold "window" edge for FSM detector
void Rhd2000EvalBoard::setDacWindowStop(int dacChannel, int sample)
{
    if (dacChannel < 0 || dacChannel > 7) {
        cerr << "Error in Rhd2000EvalBoard::setDacWindowStop: dacChannel out of range." << endl;
        return;
    }

    if (sample < 0 || sample > 65535) {
        cerr << "Error in Rhd2000EvalBoard::setDacWindowStop: sample value out of range." << endl;
        return;
    }
...
void Rhd2000EvalBoard::changeThresholdType(int dacChannel, int typeIndex)
{
    if (dacChannel < 0 || dacChannel > 7) {
        cerr << "Error in Rhd2000EvalBoard::changeThresholdType: dacChannel out of range." << endl;
        return;
    }

    if (typeIndex < 0 || typeIndex > 1) {
        cerr << "Error in Rhd2000EvalBoard::changeThresholdType: typeIndex out of range." << endl;
    }
...
void Rhd2000EvalBoard::setDetectionMode(bool enable)
{
