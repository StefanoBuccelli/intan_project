...
void RenameChannelDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        RenameChannelDialog *_t = static_cast<RenameChannelDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject RenameChannelDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_RenameChannelDialog.data,
      qt_meta_data_RenameChannelDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *RenameChannelDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RenameChannelDialog.stringdata0))
        return static_cast<void*>(const_cast< RenameChannelDialog*>(this));
