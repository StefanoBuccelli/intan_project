...
struct qt_meta_stringdata_HelpDialogDacs_t {
    QByteArrayData data[1];
    char stringdata0[15];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_HelpDialogDacs_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_HelpDialogDacs_t qt_meta_stringdata_HelpDialogDacs = {
    {
QT_MOC_LITERAL(0, 0, 14) // "HelpDialogDacs"
...
const QMetaObject HelpDialogDacs::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_HelpDialogDacs.data,
      qt_meta_data_HelpDialogDacs,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *HelpDialogDacs::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_HelpDialogDacs.stringdata0))
